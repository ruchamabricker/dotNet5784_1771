        ...
        public static void DependencyFunction()
        {
            ...
            switch ((CRUD)crudChoice)
            {
                ...
                case CRUD.CREATE:
                    ...
                    Console.WriteLine("the id of the new dependency is: "+s_dalDependency.Create(new Dependency(0, dependsOn, dependent)));
                    break;
                case CRUD.READ:
            ...
            switch ((CRUD)crudChoice)
            {
                ...
                case CRUD.UPTADE:
                    ...
                    try
                    {
                        ...
                        s_dalTask.Update(new DO.Task(id, description, alias, engineerID, complexityLevel, createdAt));
                        Console.WriteLine("updated successfuly");
                    }
                    catch (Exception ex)
                    {
